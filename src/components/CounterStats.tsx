...
const CounterStats: React.FC = () => {
    return (
        <div className="p-4 bg-[#F5F7FA] shadow-md flex flex-wrap justify-center items-center py-10 my-10">
            <div className='flex flex-col gap-4'>
                <h2 className="text-[#4D4D4D] text-4xl font-semibold lg:w-[60%] sm:text-center sm:w-[80%] sm:text-xl">
